...
export const GI_PAGE_SIZE = DEFAULT_PAGE_SIZE
...
function ownerName(matter: MatterListItem): string {
  const summary = matter.giSummary
      ...
      <Table>
        <TableHeader>
          <TableRow className="border-border/80 bg-muted/50 hover:bg-muted/50">
            <TableHead className="min-w-[160px]">{t('giList.columns.name')}</TableHead>
            <TableHead className="min-w-[100px]">{t('giList.columns.territory')}</TableHead>
            <TableHead className="min-w-[130px]">{t('giList.columns.incomingRef')}</TableHead>
            <TableHead className="min-w-[120px]">{t('giList.columns.status')}</TableHead>
            <TableHead className="min-w-[110px]">{t('giList.columns.classification')}</TableHead>
            <TableHead className="min-w-[140px]">{t('giList.columns.owner')}</TableHead>
            <TableHead className="min-w-[120px]">{t('giList.columns.registration')}</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="text-sm">
                    {giTerritoryLabel(summary?.territoryCode ?? null)}
                  </TableCell>
