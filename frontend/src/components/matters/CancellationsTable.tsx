...
export const CANCELLATIONS_PAGE_SIZE = DEFAULT_PAGE_SIZE
        ...
        <TableHeader>
          <TableRow className="border-border/80 bg-muted/50 hover:bg-muted/50">
            <TableHead className="min-w-[140px]">
              {t('cancellationList.columns.againstMark')}
            </TableHead>
            <TableHead className="min-w-[160px]">
              {t('cancellationList.columns.client')}
            </TableHead>
            <TableHead className="min-w-[140px]">
              {t('cancellationList.columns.status')}
            </TableHead>
            <TableHead className="min-w-[140px] text-right">
              {t('cancellationList.columns.actions')}
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
                ...
                <div className="mx-auto flex max-w-sm flex-col items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      {t('cancellationList.emptyDescription')}
                    </p>
                  </div>
                </div>
              </TableCell>
          ...
          {!isLoading &&
            ...
            items.map((matter, index) => {
              const stage = matter.trademarkSummary?.cancellationStage
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1">
                      ...
                      <Button
                        ...
                        title={t('cancellationList.fileArchive')}
                      >
