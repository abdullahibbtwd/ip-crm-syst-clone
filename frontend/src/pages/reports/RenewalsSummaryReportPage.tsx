...
import { RenewalsSummaryReport } from '@/components/reports/RenewalsSummaryReport'
import { buttonVariants } from '@/components/ui/button'
import { cn } from '@/lib/utils'

export function RenewalsSummaryReportPage() {
          ...
          <div className="flex flex-wrap items-start gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl text-white md:text-3xl">
                {t('renewalsSummary.title')}
              </h1>
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-white/75">
                {t('renewalsSummary.description')}
              </p>
            </div>
          </div>
        </div>
      </div>
      <RenewalsSummaryReport />
    </div>
  )
}
