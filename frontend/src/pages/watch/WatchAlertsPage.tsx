...
import { AlertTriangle, CheckCircle2, Eye, Sparkles, XCircle } from 'lucide-react'
...
const SOURCES: WatchRegistrySource[] = ['BPO', 'EUIPO', 'WIPO']
      ...
      <div className="relative overflow-hidden rounded-2xl border border-primary/15 bg-gradient-to-br from-primary/[0.06] via-white to-brand-green/[0.04] p-6 shadow-[0_8px_40px_rgba(26,60,52,0.06)]">
        ...
        <div className="relative flex flex-wrap items-start justify-between gap-4">
          ...
          <PermissionGate resource="matter" action="create">
            <Button
              variant="outline"
              className="border-primary/20 bg-white/70 backdrop-blur-sm"
              onClick={() => void createMock.mutate({})}
